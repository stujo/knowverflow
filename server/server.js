...
passportConfigurator.setupModels({
  ...
  userIdentityModel: loopbackPassport.UserIdentity,
  userCredentialModel: loopbackPassport.UserCredential
});

// attempt to build the providers/passport config
try {
  var passportProvidersConfig = require('./passport-providers-config')(app);
  for (var s in passportProvidersConfig) {
    var c = passportProvidersConfig[s];
...
// We already mounted the static files in middleware.json
